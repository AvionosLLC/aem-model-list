window.AEMModelList = window.AEMModelList || {};
AEMModelList.Lists = AEMModelList.Lists || {};

AEMModelList.Lists.v1 = function( ns, channel ) {
    ...
    var ListsEditor = function() {
         ...
         * @param options.refresh Indicates that the list container should be refreshed after completion of the operation
         */
        this.addListItem = function ( editable, item, options ) {
            ...
            return $.ajax( {
                ...
                .done(function ( result ) {
                    ...
                    if ( options.refresh ) {
                        ns.edit.actions.doRefresh( editable );
                    }
